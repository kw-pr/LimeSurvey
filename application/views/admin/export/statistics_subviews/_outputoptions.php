        ...
        <div class="panel-body">
            <div class="row">
                <div class='form-group col-md-6'>
                    ...
                    <div class='col-lg-4'>
                        <?php $sShowtextinline = (int) Yii::app()->request->getPost('showtextinline', App()->getConfig('statistics_showtextinline'));?>
                ...
                <div class='form-group col-md-6'>
                    ...
                    <div class='col-lg-4'>
                        <?php $sUsegraph = (int) Yii::app()->request->getPost('usegraph', App()->getConfig('statistics_usegraph'));?>
                        <?php $this->widget('yiiwheels.widgets.switch.WhSwitch', 
